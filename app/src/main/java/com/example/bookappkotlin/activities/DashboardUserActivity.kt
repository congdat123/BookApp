    ...
    private fun setupWithViewPagerAdapter(viewpager: ViewPager){
        ...
        ref.addListenerForSingleValueEvent(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                //Add date to models
                var modelAll = ModelCategory("01","All",1,"")
                var modelMostView = ModelCategory("01","Most Viewed",1,"")
                var modelMostDownLoaded = ModelCategory("01","Most Downloaded",1,"")
                //add to lo list
...
//    Ở activity có thể mở sau khi đăng nhập
