...
class PdfEditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //get book id to edit th book info
        ...
        ref.child(bookId)
            .addListenerForSingleValueEvent(object : ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    //get book info
                    seletedCategoryId = snapshot.child("categoryId").value.toString()
    ...
    private fun validateData() {
        ...
        else if (seletedCategoryId.isEmpty()){
    ...
    private fun updatePdf() {
        ...
        hashMap["categoryId"] = "$seletedCategoryId"
    ...
    private var seletedCategoryId = ""
    private var seletedCategoryTitle = ""
    private fun categoryDialog() {
        ...
        builder.setTitle("Choose Category")
            .setItems(categoriesArray){dialog, position ->
                ...
                seletedCategoryId = categoryIdArrayList[position]
                seletedCategoryTitle = categoryTitleArrayList[position]

                //set to textview
                binding.categoryTv.text = seletedCategoryTitle
            }
            .show() //show dialog
    }
