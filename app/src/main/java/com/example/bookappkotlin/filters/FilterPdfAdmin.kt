...
/*User to filter data from recyclerview | search pdf from pdf list in recyclerview*/
class FilterPdfAdmin: Filter {
    ...
    override fun performFiltering(constraint: CharSequence?): FilterResults {
        ...
        //value to be search should no be null and not empty
    ...
    override fun publishResults(constraint: CharSequence, results: FilterResults?) {
        ...
        adapterPdfAdmin.pdfArrayList = results!!.values as ArrayList<ModelPdf> /* = java.util.ArrayList<com.example.bookappkotlin.models.ModelPdf> */
